...
with st.sidebar:
    ...
    selected = option_menu('Real Time Disease Prediction System',
                          ...
                          icons=['activity','heart','person'], menu_icon="cast",
                          default_index=0)
...
if (selected == 'Autism Prediction'):
    ...
    if st.button("CHECK UP"):
        autism_prediction = Autism_model.predict([[A1_Score, A2_Score, A3_Score, A4_Score, A5_Score, A6_Score, A7_Score,A8_Score,A9_Score,A10_Score,age,result]])                          
